...
\email{duvallet@mit.edu} & 9 Seattle St \\
cduvallet.github.io & Allston, MA 02134 \\
...
\textbf{Massachusetts Institute of Technology} \hfill {2015 -- present}\\
Department of Biological Engineering \\
Supervisor: Eric J. Alm, Ph.D. \\
	
I study the relationship between the microbiome and health and disease, and am generally interested in personalized medicine approaches for public health applications. \\
...
\item{Developing a metagenomics-based metric to quantify selective pressure and risk for antimicrobial resistance in sewage and environmental samples}
...
\vspace{-.1275in}
\begin{bibsection}
	\item \textbf{Claire Duvallet}, Kara Larson, Scott Snapper, Sonia Iosim, Ann Lee, Katherine Freer, Kara May, Eric J. Alm, and Rachel Rosen. (2018) \\ 
		``Altered relationships between gastric, lung, and oropharyngeal microbiomes in patients with aerodigestive symptoms.'' \\ 
		\emph{Microbiome}, \textit{submitted}.
	\item Sean M. Gibbons, \textbf{Claire Duvallet}, and Eric J. Alm. (2018) \\ 
		``Correcting for batch effects in case-control microbiome studies.'' \\ 
		\emph{PLoS Computational Biology}. doi: 10.1371/journal.pone.0176335.
	\item \textbf{Claire Duvallet}. (2018) \\ 
		``Meta-analysis generates and prioritizes hypotheses for translational microbiome research.'' \\ 
		\emph{Microbial Biotechnology}. doi: 10.1111/1751-7915.13047.
	\item \textbf{Claire Duvallet}, Sean M. Gibbons, Thomas Gurry, Rafael A. Irizarry, and Eric J. Alm. (2017) \\ 
		``Meta-analysis of gut microbiome studies identifies disease-specific and shared responses.'' \\ 
		\emph{Nature Communications}. doi: 10.1038/s41467-017-01973-8.
	\item Scott W. Olesen, \textbf{Claire Duvallet}, and Eric J. Alm. (2017) \\ 
		``dbOTU3: A new implementation of distribution-based OTU calling.'' \\ 
		\emph{PloS ONE}. doi: 10.1371/journal.pone.0176335.
	\item \textit{[Non-peer reviewed blog post]} \textbf{Claire Duvallet}. (2017) \\ 
		...
		\emph{Nature Microbiology Community Forum}.
	\item \textit{[Dataset]} \textbf{Claire Duvallet}, Sean M. Gibbons, Thomas Gurry, Rafael A. Irizarry, and Eric J. Alm. (2017) \\ 
		``MicrobiomeHD: the human gut microbiome in health and disease.'' \\ 
		\emph{Zenodo}. doi: 10.5281/zenodo.797943
\end{bibsection}
...
\begin{bibsection}
\item ``Predictive power of the microbiome.'' International Conference on Microbiome Engineering (ICME 2018). Boston, MA. Nov. 2018. \textit{Invited}.
...
Correcting batch effects in case-control microbiome studies. (Gibbons \textit{et al.}, 2018). \\
\begin{innerlist}
	\item[] Python implementation: github.com/seangibbons/percentile\_normalization \textit{(contributor)}
	\item[] QIIME 2 plugin: github.com/cduvallet/q2-perc-norm \textit{(developer)}
\end{innerlist}
\vspace{.15in}

\textbf{Distribution-based OTU calling} \\
New implementation of Preheim \textit{et al}.'s distribution-based OTU clustering algorithm. (Preheim \textit{et al.}, 2013; Olesen \textit{et al.}, 2017). \\
\begin{innerlist}
	\item [] Python implementation: github.com/swo/dbotu3 \textit{(contributor)}
    \item [] QIIME 2 plugin: github.com/cduvallet/q2-dbotu \textit{(developer)}
\end{innerlist}
\vspace{.15in}
...
\begin{innerlist}
	\item [] Python: github.com/thomasgurry/amplicon\_sequencing\_pipeline \textit{(co-developer)}
\end{innerlist}
\vspace{.15in}
...
\begin{outerlist}
	\item[] MIT Biotech Group \hfill {2017 -- present} \\ \textit{Beyond the Bench Initiative board member} 
	\item[] MIT Microbiome Club \hfill {2015 -- present} \\ \textit{Co-Founder, President, Executive board member}
	\item[] MIT-Harvard Microbiome Symposium \hfill {2016 and 2017} \\ \textit{Co-Founder and organizing committee} 
\end{outerlist}
\vspace{.15in}
...
\textbf{Fellowships}
\begin{outerlist}
	\item[] National Defense Science and Engineering Graduate Fellowship \hfill {2016 -- 2018} \\
...
As a Luce Scholar, I was one of the first lecturers for Engineering World Health's new Associate Bachelor’s program in Biomedical Equipment Technology at the University of Puthisastra. \\
