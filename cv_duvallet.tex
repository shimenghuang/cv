...
%\section{Skills}
%
%\textbf{Technical}: Python (pandas, seaborn, matplotlib, scikit-learn, etc); git and GitHub; AWS (S3, EC2, Glacier, IAM); bash; LaTeX; R (proficient); data wrangling and exploration; machine learning; NGS analysis (16S, metagenomics); untargeted metabolomics analysis. 
%\vspace{.1in}
%
