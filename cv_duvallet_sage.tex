...
\vspace{-.1275in}
\begin{bibsection}
	\item \textbf{Claire Duvallet}, Caroline Zellmer, Pratik Panchal, Shrish Budree, Madji Osman, and Eric Alm. (2018) \\ 
		``Framework for rational donor selection in fecal microbiota transplant clinical trials.'' \\ 
		\textit{in preparation}.
	\item Mariana Matus, \textbf{Claire Duvallet}, Newsha Ghaeli, Melissa Soule, Krista Longnecker, Ilana Brito, Carlo Ratti, Elizabeth B. Kujawinski, Eric Alm. (2018) \\ 
...
\begin{outerlist}
	\item[] MIT Biotech Group \hfill {2017 -- 2018} \\ \textit{Beyond the Bench Initiative board member} 
	\item[] MIT Microbiome Club \hfill {2015 -- 2018} \\ \textit{Co-Founder, President, Executive board member}
