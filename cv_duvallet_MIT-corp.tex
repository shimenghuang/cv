...
Biobot Analytics measures opioids in sewage to estimate consumption in cities. As Biobot Analytics' first data scientist. 
...
\begin{bibsection}
	...
	\item \textbf{Claire Duvallet}.  (\textit{in press}) \\ 
		``Data detectives, self-love, and humility: a research parasite's perspective.'' \\
		\textit{GigaScience}.

	\item Noriko Endo, Newsha Ghaeli, \textbf{Claire Duvallet}, Katelyn Foppe, Tim Erickson, Mariana Matus, and Peter Chai. (\textit{submitted}) \\ 
		...
		\textit{Journal of Medical Toxicology}.
